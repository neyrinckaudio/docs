...
|  |  |
| Automation |  |
| The D-Command provides comprehensive automation control for Pro Tools. |  |
...
|  |  |
| Function Keys |  |
| F1-F8 | Programmable function keys for Pro Tools commands. |
| Shift | Modifier key for accessing secondary functions. |
| Alt | Alternative modifier key. |
| Ctrl | Control modifier key. |
|  |  |
| Display |  |
| LCD Displays | Channel information and parameter values specific to Pro Tools. |
