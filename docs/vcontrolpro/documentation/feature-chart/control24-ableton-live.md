# Control|24 with Ableton Live

## MIDI Mode
| Control | Function |
|---------|----------|
| MIDI Mode | MIDI Mode converts the surfaces faders, knobs, and buttons into assignable MIDI Controls that can be mapped in the |
...
| Control | Function |
|---------|----------|
| Cursor Buttons | The cursor buttons operate in several modes. |
...
| Control | Function |
|---------|----------|
| Wheel Modes | There are two modes to use with the wheel |
...
| Control | Function |
|---------|----------|
| Soft Keys for ProControl | Use the Ableton Live MIDI mapping mode to map keys to functions. |
