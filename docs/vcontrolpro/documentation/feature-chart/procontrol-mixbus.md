...
|  |  |
| Automation |  |
| The ProControl has dedicated buttons for handling track automation in Mixbus. |  |
...
|  |  |
| Status / Group |  |
| The Status / Group Buttons control various aspect of Mixbus's Mix window and track grouping functions. |  |
